...
async function crearCotizacionAccesorio(data) {
    ...
    const [cotResult] = await db_1.default.query("INSERT INTO cotizaciones (cliente_id, tipo, estado) VALUES (?, 'accesorio', 'En proceso')", [clienteId]);
    const cotizacionId = cotResult.insertId;
    await db_1.default.query("INSERT INTO cotizacion_accesorio (cotizacion_id, accesorio_id, cantidad) VALUES (?, ?, ?)", [cotizacionId, data.accesorio_id, data.cantidad]);
    return cotizacionId;
}
